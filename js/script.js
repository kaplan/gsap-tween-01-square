...
function initAnimation() {
	...
	TweenMax.to(box, 0.5, {css:{rotation:360, backgroundColor:colorSet.dark}, ease:Quad.easeInOut, delay:1.5});
	TweenMax.to(document.body, 1, {css:{backgroundColor:colorSet.bright}, delay:2.0});
	...
	tl.to(txtEl, 1, {css:{color:colorSet.bright}, ease:Quad.easeOut});
	...
	function animateSquare() {
		...
		TweenMax.to(sq, 1, {css:{backgroundColor:colorSet.bright}, ease:Quad.easeOut, delay:1});
		tl.play();
	}
